          ...
          <Switch>
            ...
            <Route path='/grade/:examID/:submissionID?/:problemID?' render={({ match, history }) => (
              exam.submissions.length && exam.problems.length && grader
                ? <Grade examID={match.params.examID} gradeAnonymous={exam.gradeAnonymous} graderID={this.state.grader.id} changeURL={history.replace} submissionID={match.params.submissionID} problemID={match.params.problemID} />
