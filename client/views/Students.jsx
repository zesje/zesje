...
class CheckStudents extends React.Component {
  ...
  prev = () => {
    ...
    if (newIndex >= 0 && newIndex < this.props.exam.submissions.length) {
      ...
      this.props.updateSubmissionByID(this.props.exam.submissions[newIndex].id)
    }
  }
  next = () => {
    const newIndex = this.state.index + 1
  ...
  prevUnchecked = () => {
    for (let i = this.state.index - 1; i >= 0; i--) {
      if (this.props.exam.submissions[i].validated === false) {
        ...
        this.props.updateSubmissionByID(this.props.exam.submissions[i].id)
        return
      }
    }
  }
  ...
  setSubmission = (id) => {
    ...
    this.props.updateSubmissionByID(id)
  }
