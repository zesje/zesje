...
def mco_json():
    return {"x": 100, "y": 40, "problem_id": 1, "label": "a", "name": "test"}


def fo_json(root_id):
    return {"name": "fully correct", "description": "", "score": 4, "parentId": root_id}


def fo_child_json():
    return {"name": "minor math error", "description": "", "score": 4, "parentId": 5}


def fo_subchild_json():
    return {"name": "integration error", "description": "", "score": 2}
...
@pytest.mark.parametrize(
    ...
    ids=["Valid name", "Invalid name", "Valid score", "Invalid score", "Valid description", "Valid empty description"],
)
