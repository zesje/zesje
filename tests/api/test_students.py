...
def test_get_students(test_client):
    students = [new_student(1000000, ""), new_student(1000001, "student@school.edu")]
...
@pytest.mark.parametrize(
    ...
    [
        (
            [[1000000, "a", "b", "c@c.nl"], [1000000, "a2", "b2", "c@c.nl"]],
            [200, 200],
            {1000000: ["a2", "b2", "c@c.nl"]},
        ),
        ([[1000000, "a", "b", "c@c.nl"], [1000001, "a2", "b2", "c@c.nl"]], [200, 400], {1000000: ["a", "b", "c@c.nl"]}),
        (
            [[1000000, "a", "b", "c@c.nl"], [1000000, "a2", "b2", "c2@c2.nl"]],
            [200, 200],
        ...
        (
            ...
            [200, 200, 400],
            {1000000: ["a", "b", "c@c.nl"], 1000001: ["a2", "b2", "c2@c2.nl"]},
        ),
    ],
...
def new_student(id, mail, first="First", last="Last"):
    return {"studentID": id, "firstName": first, "lastName": last, "email": mail or None}
