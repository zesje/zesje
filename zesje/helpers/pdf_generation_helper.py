...
def generate_pdfs(exam_pdf_file, exam_id, output_dir, num_copies, id_grid_x,
    ...
    for copy_idx in range(num_copies):
        ...
        with NamedTemporaryFile() as overlay_file:
            # Generate overlay
            overlay_canv = canvas.Canvas(overlay_file.name, pagesize=A4)
            _generate_overlay(overlay_canv, exam_id, copy_idx,
...
def _generate_overlay(canv, exam_id, copy_num, num_pages, id_grid_x, id_grid_y,
                      datamatrix_x, datamatrix_y):
    """
